...
desc_id_column = 0
desc_ident_column = 3
desc_subject_column = 5
desc_description_column = 6
desc_tracker_column = 7
desc_parent_column = 10
desc_blocking_column = 11
desc_precedents_column = 12
desc_min_column = 13
desc_def_column = 14
desc_max_column = 15
desc_deftext_column = 16
